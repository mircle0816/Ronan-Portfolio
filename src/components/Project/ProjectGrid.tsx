...
const PROJECT_OVERRIDES: Record<string, ProjectOverride> = {
  ...
  "Flashcards": {
    ...
    description:
      "A real-time chat application built with React and Socket.io for instant messaging between users. Features a client-server architecture with separate frontend and backend services.",
    repoLink: "https://github.com/mircle0816/React-ChatApp.git",
    liveLink: "https://react-chatsapp.vercel.app",
    imageUrl:
      "https://images.unsplash.com/photo-1611746872915-64382b5c76da?auto=format&fit=crop&w=1280&q=80",
    projectLogo: {
      url: "https://cdn.simpleicons.org/socketdotio/6E6E6E",
    },
    technologiesUsed: [
      {
        id: "c1",
      ...
      },
      {
        id: "c3",
        name: "Socket.io",
        logo: { url: "https://cdn.simpleicons.org/socketdotio/6E6E6E" },
      },
      {
        id: "c4",
        name: "Node.js",
